...
export class Class4Api extends runtime.BaseAPI {
     ...
     */
    async getRandomPinnedQuestionOfApartmentUsingGETRaw(requestParameters: GetRandomPinnedQuestionOfApartmentUsingGETRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<CommonResponseBodyOneQuestionDto>> {
        if (requestParameters.apartmentId === null || requestParameters.apartmentId === undefined) {
            throw new runtime.RequiredError('apartmentId','Required parameter requestParameters.apartmentId was null or undefined when calling getRandomPinnedQuestionOfApartmentUsingGET.');
        }
        ...
        const response = await this.request({
            path: `/api/v1/apartment/{apartmentId}/question/pinned`.replace(`{${"apartmentId"}}`, encodeURIComponent(String(requestParameters.apartmentId))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * 사용자에게 보여질 핀 질문 랜덤 조회
     */
    async getRandomPinnedQuestionOfApartmentUsingGET(requestParameters: GetRandomPinnedQuestionOfApartmentUsingGETRequest, initOverrides?: RequestInit): Promise<CommonResponseBodyOneQuestionDto> {
        const response = await this.getRandomPinnedQuestionOfApartmentUsingGETRaw(requestParameters, initOverrides);
        return await response.value();
    }
