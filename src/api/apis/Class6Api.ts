...
export class Class6Api extends runtime.BaseAPI {
   ...
   * 자신의 아파트 체크인 정보 업데이트
   */
  async changeMyCheckedInUsingPATCHRaw(
    requestParameters: ChangeMyCheckedInUsingPATCHRequest,
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<CommonResponseBodyVoid>> {
    if (
      requestParameters.newCheckedInInfo === null ||
      requestParameters.newCheckedInInfo === undefined
    ) {
      throw new runtime.RequiredError(
        "newCheckedInInfo",
        "Required parameter requestParameters.newCheckedInInfo was null or undefined when calling changeMyCheckedInUsingPATCH."
      );
    }
   ...
   * 자신의 아파트 체크인 정보 업데이트
   */
  async changeMyCheckedInUsingPATCH(
    requestParameters: ChangeMyCheckedInUsingPATCHRequest,
    initOverrides?: RequestInit
  ): Promise<CommonResponseBodyVoid> {
    const response = await this.changeMyCheckedInUsingPATCHRaw(
      requestParameters,
      initOverrides
    );
   ...
   * 자신의 정보 조회
   */
  async getMyInfoUsingGETRaw(
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<CommonResponseBodyUserDto>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      CommonResponseBodyUserDtoFromJSON(jsonValue)
    );
  }
   ...
   * 자신의 정보 조회
   */
  async getMyInfoUsingGET(
    initOverrides?: RequestInit
  ): Promise<CommonResponseBodyUserDto> {
